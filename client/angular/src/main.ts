...
import { HammerModule, BrowserModule, bootstrapApplication } from '@angular/platform-browser';
...
bootstrapApplication(AppComponent, {
    providers: [
        importProvidersFrom(AppRoutingModule, ApiModule, TranslocoModule, TranslocoRootModule, HammerModule, BrowserModule, ReactiveFormsModule, FormsModule, OAuthModule.forRoot({
            resourceServer: {
                allowedUrls: ['https://localhost:8888'],
                sendAccessToken: true,
            },
        }), FontAwesomeModule, NgChartsModule),
        KeyStoreService,
