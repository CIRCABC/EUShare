...
public interface MeApi {
    ...
    @ApiOperation(value = "", nickname = "getUserInfo", notes = "", response = UserInfo.class, authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={ "Me", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns the UserInfo about the currently logged-in user", response = UserInfo.class),
    ...
    @RequestMapping(value = "/me/userInfo",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<UserInfo> getUserInfo() {
