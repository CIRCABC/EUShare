...
@Entity
@Table(name = "logs")
@NamedNativeQuery(name = "DBFileLog.getLastLogs", query = "SELECT id, email, name, username, total_space, last_logged FROM users where username like 'n00%' order by last_logged desc", resultSetMapping = "getLastLogsMapping")
