...
public class LastLog   {
  ...
  */
  ...
  public LastLog totalSpace(Long totalSpace) {
  ...
  */
  ...
  public LastLog status(String status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, lastLog.id) &&
        ...
        Objects.equals(this.status, lastLog.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, email, name, username, totalSpace, lastLogged, status);
  }
