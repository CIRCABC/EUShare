...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .license("EUPL V1.2")
            .licenseUrl("https://joinup.ec.europa.eu/sites/default/files/inline-files/EUPL%20v1_2%20EN(1).txt")
            .termsOfServiceUrl("")
            .version("0.1")
            .contact(new Contact("","", ""))
            .build();
    ...
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.easyShare.base-path:/auth/realms/dev/.well-known/openid-configuration}") String basePath) {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("eu.europa.circabc.eushare.api"))
                    .build()
